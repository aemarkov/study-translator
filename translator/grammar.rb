...
class Simple_Grammar < Grammar
  ...
  @@nonterminals=
  {
    "Expr"    => Lexem.new(100,0),
    "Term"    => Lexem.new(101,0),
    "Mult"    => Lexem.new(102,0),
  }

  @@grammar=
  [
    Rule.new(@@nonterminals["Expr"],    [@@nonterminals["Term"]]),
    Rule.new(@@nonterminals["Expr"],    [@@nonterminals["Term"], @@terminals["+"], @@nonterminals["Expr"]]),
    Rule.new(@@nonterminals["Term"],    [@@nonterminals["Mult"]]),
    Rule.new(@@nonterminals["Term"],    [@@nonterminals["Mult"], @@terminals["*"], @@nonterminals["Term"]]),
    Rule.new(@@nonterminals["Mult"],    [@@terminals["@id"]]),
    Rule.new(@@nonterminals["Mult"],    [@@terminals["("], @@nonterminals["Expr"], @@terminals[")"]])
  ]
end