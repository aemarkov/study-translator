...
# !!!!!!!!!!!!!!! TODO !!!!!!!!!!!!!!!!!!!
#Сейчас этот класс весьма странным образом делает 1 текст на один объект. Нахера?
#Сам объект должен иметь только грамматику, а тексты передаваться должны в методе parse
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

class Lexer

	#Регулярные выражения для разбора строки
	@@regExpes=[
	/'[^']*'/,		#Строковая константа
	...
	#Конструктора
	# param[in] text -  Исходный текст программы
